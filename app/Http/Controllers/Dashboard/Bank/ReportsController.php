...
class ReportsController extends Controller
{
    ...
    {   exit("Unavailable");
        systemActivities(Auth::id(), json_encode($request->query()), "Bank Reports");
        return view('dashboard.bank.reports');
    }
    ...
    public function getData(Request $request)
    {
        ...
        return BankData::bankReportsData(null,function ($data) use($start,$rowperpage,$draw,$columnIndex,$columnName,$columnSortOrder,$searchValue,$request){
                    ...
                    foreach ($search_columns as $search_column) {
                        switch ($search_column) {
                            ...
                            case 'depositor_name':
                                ...
                                break;
                            case 'reference_no':
                                $query->orWhere('deposits.reference_no', 'like', '%' . $searchValue . '%');
                                break;
                        }
                    }
                });
            ...
            if( $request->filled("export") ){
                $data = $data->get();
                $pdf = PDF::loadView('dashboard.bank.exports.reports', compact('data'));
