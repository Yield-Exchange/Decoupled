...
class AccountLockedMail extends Mailable implements ShouldQueue
{
    ...
    {
        $data = $this->data;
        $data['subject']=setEmailHeader("Your account has been locked!");
        ...
        return $this->view('emails.auth.account-locked',compact('message_','show_login','show_register','other_buttons','logo_position','header','subject','user_type'))
