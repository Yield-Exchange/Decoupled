...
class NewUserPasswordMail extends Mailable
{
    ...
    {
        $data = $this->data;
        $data['subject']=setEmailHeader("Your account has been created on Yield Exchange.");
        ...
        return $this->view('emails.auth.new-user-password',compact('password','show_login','show_register','other_buttons','logo_position','header','subject','user_type'))
