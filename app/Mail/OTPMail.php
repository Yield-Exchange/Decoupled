...
class OTPMail extends Mailable
{
    ...
    {
        $data = $this->data;
        $data['subject']=setEmailHeader("Your Verification Code");
        ...
        return $this->view('emails.auth.pin',compact('pin','show_login','show_register','other_buttons','logo_position','header','subject','user_type'))
