...
class MarkDepositInactive extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.depositor.withdraw-deposit',compact('message_','show_login','show_register','other_buttons','logo_position','header','subject','user_type'))
