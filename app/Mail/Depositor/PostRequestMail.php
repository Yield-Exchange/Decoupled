...
class PostRequestMail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.depositor.post-request',compact('message_','show_login','show_register','other_buttons','logo_position','header','subject','user_type'))
