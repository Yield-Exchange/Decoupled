...
class BlogCategoryService extends BaseService{
     public function fetch(Request $request)
     {
         ...
         foreach($data as $record) {
             ...
             $action = "";
             if($user->userCan('admin/blogs-categories/edit')) {
                 $action = '<div id="edit-blog-category-' . $record->id . '" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><b>Update Blog Category</b></h5>
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="blog_category_id" value="' . $record->id . '" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 well">
                                            ...
                                            <div class="form-group">
                                                <input type="text" value="' . $record->name . '" id="name" name="name" placeholder="Enter Category" maxlength="26" minlength="1"  class="form-control col-md-12" required/>
                                            </div>
                                        </div>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
             ...
             if($user->userCan('admin/blogs-categories/edit')) {
                 $action .= ' <a class="dropdown-item" action="' . url('/yie-admin/blogs-category/create?action=edit&blog_category_id=' . $blog_id) . '" data-toggle="modal" data-target="#edit-blog-category-' . $record->id . '" href="javascript:void()">Edit</a> ';
             }
             if($user->userCan('admin/blogs-categories/delete')) {
                 $action .= ' <a class="dropdown-item admin-delete-blog-category" action="' . url('/yie-admin/blogs-category-delete?action=delete&blog_category_id=' . $blog_id) . '" href="javascript:void()">Delete</a> ';
             }
     ...
     public function update(array $data, Model $blogCategory) : Model
     {
     ...
     public function delete(Model $blogCategory) : Model
     {
         $blogCategory->delete();
         return $blogCategory;
     }
