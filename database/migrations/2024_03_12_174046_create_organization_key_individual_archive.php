...
class CreateOrganizationKeyIndividualArchive extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('organization_key_individual_archive', function (Blueprint $table) {
            $table->id();
            $table->string('organization_id');
            $table->string('organization_key_individual_id');
    ...
    {
        Schema::dropIfExists('organization_key_individual_archive');
    }
}
