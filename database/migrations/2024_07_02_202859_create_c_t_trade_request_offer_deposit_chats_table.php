...
class CreateCTTradeRequestOfferDepositChatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_t_trade_request_offer_deposit_chats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('c_t_trade_request_offer_deposit_chats');
    }
}
