...
class CreateMT569SummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_t569_summaries', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamp('valuation_date')->nullable()->comment('Valuation Date(98C::VALN)');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('m_t569_summaries');
    }
}
