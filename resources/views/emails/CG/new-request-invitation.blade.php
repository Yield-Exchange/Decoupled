        ...
        <div style="width: 100%; text-align: center;">
            ...
            <div class="w-100 d-flex justify-content-center" style="width:100%" width="100%">
                <p class="notify"
                    ...
                    align="center">  <span style="color: #252525; font-size: 24px; font-family: Montserrat; font-weight: 400; word-wrap: break-word"><span style="color: #252525; font-size: 24px; font-family: Montserrat; font-weight: 700; word-wrap: break-word">{{$CTRequest['sender']->name}} </span></span> has sent a request for the following investments. 
                    If you are interested in putting in an offer, please login and submit your offers.</p>
                    ...
                    <thead style="color:#5063F4; font-weight:700; padding:1rem; background-color:#EFF2FE"
                        ...
                        <tr>
                            <th style="padding:0.6rem; text-align:start; border-bottom:3px solid white; border-top:none"
                                align="start">Preffered Collateral Name
                            </th>  
                            <th style="padding:0.6rem; text-align:start; border-bottom:3px solid white; border-top:none"
                            align="start">Term
                        </th> 
