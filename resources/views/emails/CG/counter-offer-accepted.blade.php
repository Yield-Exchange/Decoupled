...
<div style="padding: 0 5%;margin-right:auto; margin-left:auto;" class="responsive">
       <div class="w-100 d-flex justify-content-center my-2 campaign-status-text "
        ...
        <div class="w-100 d-flex justify-content-center my-2 campaign-status-text "
            ...
            align="center">
            Repo Counter Offer Accepted      
        </div>
        <div style="width: 100%; text-align: center;">
            <img src="{{ asset('assets/emails/counterofferaccepted.png') }}" class="cover-image" alt=""
            ...
            <div class="w-100 d-flex justify-content-center" style="width:100%" width="100%">
                <p class="notify"
                    ...
                    align="center"> You have accepted an offer from  <span style="color: #5063F4;font-family: Montserrat;font-size: 20px;font-style: normal;
                    font-weight: 700;line-height: 26px;">{{$CTRequest->c_t_trade_request->inviter->name}}</span>. </p>
            </div>                
