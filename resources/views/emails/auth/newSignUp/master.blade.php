...
<body>
    ...
    <div class="container my-4"
        ...
        <div class="w-100"
            style="box-sizing: border-box; display: table; width: 100%; margin-top: .5rem; margin-bottom: .5rem;">
        ...
        <div class="footer" style="box-sizing: border-box;">
            <div style="width: 100%; display: table; margin: 0 auto;">
                <div class="cta-icons"
                    ...
                    <a href="mailto:info@yieldexchange.ca" target="_blank"
                        style="box-sizing: border-box; color: #007bff; text-decoration: underline; background-color: transparent;">
            ...
            <div style="width: 100%; display: table; margin: 0 auto;">
                <p
                    ...
                    <span
                        ...
                        <a class="links" href="mailto:info@yieldexchange.ca"
                    ...
                    <span
                        style="box-sizing: border-box; color: #5063F4; font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 700; line-height: normal; text-decoration-line: underline;">
                        <a class="links" href="https://yieldexchange.tawk.help"
            ...
            <div style="margin: 0 auto; width: 80%; text-align: center;">
                <div style="display: inline-block; margin-right: 20px;">
                    © {{ Date('Y') }} <a href="https://yieldexchange.ca" class="links"
                ...
                <div style="display: inline-block;">
                    <a href="https://yieldexchange.tawk.help" class="links"
