...
<div style="padding: 0 5%; margin-right:auto; margin-left:auto" class="responsive">
    ...
    <div style="width: 100%; display: table; margin: 0 auto;">
        <p class="unique-key-text"
            ...
            {{$access_request['requestingUser']->name}} has requested access to the {{$access_request['details']['itemLabel']}} system feature.To approve this request, please log in and resend it to YieldExchange for further processing.
        </p>
    </div>
    <div>
