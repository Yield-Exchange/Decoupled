...
@section('page-content')
    <div style="padding: 0 5%;margin-right:auto;margin-left:auto" class="responsive">
        ...
        <div class="w-100 d-flex justify-content-center my-2 campaign-status-text "
            style="margin-top:20px; width:100%; color:#5063F4; font-family:Montserrat; font-size:38px; font-style:normal; font-weight:700; line-height:42px;text-align:center"
            width="100%">
            {{ $offersselected['depositor_name'] }} has selected your rate.
        </div>
        ...
        {{-- @if ($offersselected['lockout_period'] != 0)
            <div class="w-100 d-flex justify-content-center my-2 campaign-status-text "
                ...
                width="100%">
                {{ $offersselected['lockout_period'] . ' Days' . $offersselected['product_description'] }} &nbsp;
                GIC
            </div>
        @else
            <div class="w-100 d-flex justify-content-center my-2 campaign-status-text "
                style="width:100%; color:#5063F4; font-family:Montserrat; font-size:38px; font-style:normal; font-weight:700; line-height:42px;text-align:center"
                width="100%">
                {{ $offersselected['product_description'] }} &nbsp; GIC
            </div>
        @endif --}}
                    ...
                    @if (count($offersselected) > 0)
                        <tr>
                            ...
                            <td class="bold-txt"
                                ...
                                align="start">{{ $offersselected['lockout_period'] . ' Days ' . $offersselected['product_description'] }} </td>
                            @else
                            <td class="bold-txt"
                                style="padding:0.6rem; text-align:start; color:#252525; font-family:Montserrat; font-size:16px; font-weight:700; word-wrap:break-word; border-bottom:3px solid white; border-top:none"
                                align="start">{{ $offersselected['product_description'] }} </td>
                            @endif
                            <td class="bold-txt"
                                style="padding:0.6rem; text-align:start; color:#252525; font-family:Montserrat; font-size:16px; font-weight:700; word-wrap:break-word; border-bottom:3px solid white; border-top:none"
                                align="start">{{ number_format($offersselected['interest_rate'] ,2)}} % </td>
                            <td class="bold-txt"
                                style="padding:0.6rem; text-align:start; color:#252525; font-family:Montserrat; font-size:16px; font-weight:700; word-wrap:break-word; border-bottom:3px solid white; border-top:none"
                                align="start">CAD {{ current(explode(' ', $offersselected['offered_amount'])) }} </td>
                            <td class="bold-txt"
                                style="padding:0.6rem; text-align:start; color:#252525; font-family:Montserrat; font-size:16px; font-weight:700; word-wrap:break-word; border-bottom:3px solid white; border-top:none"
                                align="start">{{ $offersselected['deposit_date'] }}</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div
            ...
            <p
                ...
                <img src="{{ asset('assets/emails/ri_mail-add-fill.png') }}" style="padding: 0; margin: 0;"
                    height="25">   
                <span style="margin-left: 10px; color:#252525; font-weight:700; font-size:18px;">Please contact the depositor to initiate the next steps.</span>
            </p>
        </div>
