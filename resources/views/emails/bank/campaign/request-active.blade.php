    ...
    <div>
        <div class="w-100 d-flex justify-content-center my-4">
            <div class="window-button">
                ...
                <p class="m-0 p-0">Deposit Status</p>
            </div>
        </div>
        ...
        <div class="w-100 d-flex justify-content-center">
            <img src="{{ asset('assets/emails/active-request.svg') }}" class="cover-image" alt="">
        </div>
        <div class="w-100 d-flex justify-content-center">
            <p class="action-message">Your request for a <span> {{ $productName }} &nbsp GIC</span> is now
                live and ready for bids.</p>
        </div>
        {{-- <div class="w-100 d-flex justify-content-center">
            <p class="suggest-action">Here's what you can do now..</p>
        </div> --}}
        ...
        <div class="w-100 d-flex justify-content-start action-suggested align-items-center">
            <div class="d-flex align-items-center ml-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="34" viewBox="0 0 33 34" fill="none">
                    <path
                        d="M12.7875 27.8711H5.5C3.9875 27.8711 2.75 26.6336 2.75 25.1211V8.62109C2.75 7.10859 3.9875 5.87109 5.5 5.87109H13.75L16.5 8.62109H27.5C29.0125 8.62109 30.25 9.85859 30.25 11.3711V20.4461C28.325 19.0711 25.9875 18.2461 23.375 18.2461C18.5625 18.2461 14.3 21.1336 12.5125 25.5336L12.1 26.4961L12.5125 27.4586C12.65 27.5961 12.65 27.7336 12.7875 27.8711ZM31.625 26.4961C30.3875 29.6586 27.0875 31.9961 23.375 31.9961C19.6625 31.9961 16.3625 29.6586 15.125 26.4961C16.3625 23.3336 19.6625 20.9961 23.375 20.9961C27.0875 20.9961 30.3875 23.3336 31.625 26.4961ZM26.8125 26.4961C26.8125 24.5711 25.3 23.0586 23.375 23.0586C21.45 23.0586 19.9375 24.5711 19.9375 26.4961C19.9375 28.4211 21.45 29.9336 23.375 29.9336C25.3 29.9336 26.8125 28.4211 26.8125 26.4961ZM23.375 25.1211C22.55 25.1211 22 25.6711 22 26.4961C22 27.3211 22.55 27.8711 23.375 27.8711C24.2 27.8711 24.75 27.3211 24.75 26.4961C24.75 25.6711 24.2 25.1211 23.375 25.1211Z"
                        fill="#5063F4" />
                </svg>
                <span>&nbsp Monitor Request: &nbsp</span>
            </div>
            <p class="m-0 p-0">Take a look at who's placed a bid.</p>
        </div>
        <div class="w-100 d-flex justify-content-start action-suggested align-items-center">
            <div class="d-flex align-items-center ml-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="34" viewBox="0 0 33 34" fill="none">
                    <path
                        d="M8.9375 24.4336L19.25 19.6211L24.0625 9.30859L13.75 14.1211L8.9375 24.4336ZM16.5 18.2461C16.1104 18.2461 15.7836 18.1141 15.5196 17.8501C15.2556 17.5861 15.1241 17.2598 15.125 16.8711C15.125 16.4815 15.257 16.1547 15.521 15.8907C15.785 15.6267 16.1113 15.4952 16.5 15.4961C16.8896 15.4961 17.2164 15.6281 17.4804 15.8921C17.7444 16.1561 17.8759 16.4824 17.875 16.8711C17.875 17.2607 17.743 17.5875 17.479 17.8515C17.215 18.1155 16.8887 18.247 16.5 18.2461ZM16.5 30.6211C14.5979 30.6211 12.8104 30.2599 11.1375 29.5376C9.46458 28.8153 8.00938 27.8358 6.77188 26.5992C5.53438 25.3617 4.55492 23.9065 3.8335 22.2336C3.11208 20.5607 2.75092 18.7732 2.75 16.8711C2.75 14.969 3.11117 13.1815 3.8335 11.5086C4.55583 9.83568 5.53529 8.38047 6.77188 7.14297C8.00938 5.90547 9.46458 4.92601 11.1375 4.20459C12.8104 3.48318 14.5979 3.12201 16.5 3.12109C18.4021 3.12109 20.1896 3.48226 21.8625 4.20459C23.5354 4.92693 24.9906 5.90639 26.2281 7.14297C27.4656 8.38047 28.4455 9.83568 29.1679 11.5086C29.8902 13.1815 30.2509 14.969 30.25 16.8711C30.25 18.7732 29.8888 20.5607 29.1665 22.2336C28.4442 23.9065 27.4647 25.3617 26.2281 26.5992C24.9906 27.8367 23.5354 28.8166 21.8625 29.539C20.1896 30.2613 18.4021 30.622 16.5 30.6211Z"
                        fill="#5063F4" />
                </svg>

                <span>&nbsp Explore Options: &nbsp</span>
            </div>
            <p class="m-0 p-0">Submit another request.</p>
        </div>
        <div class="d-flex justify-content-center">
            <a href="{{url('')}}" class="view-button">
                View Earnings
            </a>
        </div>
        {{-- <div class="w-100 d-flex justify-content-center">
