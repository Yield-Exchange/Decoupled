...
@section('page-content')
    <div>
        ...
        <div class="w-100 d-flex justify-content-center">
            <img src="{{ asset('assets/emails/new-counter-offer.svg') }}" class="cover-image" alt="">
        </div>
        ...
        <div class="w-100  ">
            <table class="custom-table w-100 table table-hover">
                ...
                <tbody>
                    <tr>
                        <td style="font-weight: 700 !important">Minimum</td>
                        <td>1,000,0000</td>
                        <td>1,600,0000</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 700 !important">Maximum</td>
                        <td>1,000,0000</td>
                        <td>1,600,0000</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 700 !important">Rate</td>
                        <td>5.45%</td>
                        <td>20.5%</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 700 !important">Special Instructions</td>
                        <td colspan="2">None</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 700 !important">Counter Offer Expiry</td>
                        <td colspan="2">2023-11-07 20:51:00 America/Winnipeg</td>
                    </tr>
