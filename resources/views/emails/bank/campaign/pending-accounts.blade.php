...
@section('page-content')
    <div>
        <div class="w-100 d-flex justify-content-center my-4">
            <div class="window-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                    <g clip-path="url(#clip0_3591_50298)">
                        <path
        ...
        <div class="w-100 d-flex justify-content-center">
            <img src="{{ asset('assets/emails/pending-accounts.svg') }}" class="cover-image" alt="">
        </div>
        <div class="w-100 d-flex justify-content-center">
            <p class="action-message">Please review the following accounts for approval</span></p>
        </div>
        @foreach ($pendingaccounts as $key => $pending_account)
            <div class="w-100 d-flex justify-content-start account-unsuspend">
                <div class="w-100 ml-4"> {{ $key + 1 }}. &nbsp {{ $pendpending_account }} </div>
            </div>
        @endforeach
