...
@section('page-content')
    <div>
        <div class="w-100 d-flex justify-content-center my-4">
            <div class="window-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                    <g clip-path="url(#clip0_5251_460)">
                        <path
        ...
        <div class="w-100 d-flex justify-content-center">
            <img src="{{ asset('assets/emails/campaign-product-purchased.svg') }}" class="cover-image" alt="">
        </div>
        <div class="w-100 d-flex justify-content-center">
            <p class="action-message">Good News! <span> Elon Tusk LLC </span>
                products <br> from your <span> NGO Campaign </span></p>
        </div>
        {{-- <div class="w-100 d-flex justify-content-center">
