        ...
        <div style="width: 100%; text-align: center;">
            ...
            <div class="w-100 d-flex justify-content-center" style="width:100%" width="100%">
                <p class="notify"
                    ...
                    align="center"> Your {{$CTRequest->CGOffer->product->name}} investment for
                    trade ID <span style="color: #5063F4;font-family: Montserrat;font-size: 20px;font-style: normal;
                    font-weight: 700;line-height: 26px;">{{$CTRequest->deposit_reference_no}}</span> has been
