        ...
        <div style="width: 100%; text-align: center;">
            ...
            <div class="w-100 d-flex justify-content-center" style="width:100%" width="100%">
                <p class="notify"
                    ...
                    align="center">  <span style="color: #252525; font-size: 24px; font-family: Montserrat; font-weight: 400; word-wrap: break-word"><span style="color: #252525; font-size: 24px; font-family: Montserrat; font-weight: 700; word-wrap: break-word">
                        {{$CGRequest['sender']->name}} 
                    </span></span> has sent a request for the following investments. 
                ...
                <table class="width:100%; border-collapse :collapse;margin:0 auto !important; custom-table w-100 table table-hover"
                    ...
                    <tbody
                        ...
                        {{-- {{json_encode($CTRequest)}} --}}
                         @foreach ($CGRequest['requests'] as $req )
                         <tr>
                            <td style="padding:0.6rem; text-align:start; border-bottom:3px solid white; border-top:none;max-width:200px!important;"
                                ...
                                align="start">
                                {{$req->offer_term_length}} {{$req->offer_term_length_type}}
                            </td> 
                                <td style="padding:0.6rem; text-align:start; border-bottom:3px solid white; border-top:none"
                                align="start">
                                 {{$req->currency}} {{  number_format($req->offer_minimum_amount)}}
                                </td>                          
                        </tr>   
                         @endforeach
                    </tbody>
