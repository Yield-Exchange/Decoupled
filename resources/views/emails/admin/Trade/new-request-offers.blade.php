        ...
        <div style="width: 100%; text-align: center;">
            ...
            <div class="w-100 d-flex justify-content-center" style="width:100%" width="100%">
                <p class="notify"
                    ...
                    align="center">Hello Admin.A new Trade Offer has been send by {{$CTRequest['sender']->name}}.</p>
                ...
                <table class="width:100%; border-collapse :collapse;margin:0 auto !important; custom-table w-100 table table-hover"
                    ...
                    <tbody
                        ...
                        {{-- {{json_encode($CTRequest)}} --}}
                         ...
                         <tr>
                            <td style="padding:0.6rem; text-align:start; border-bottom:3px solid white; border-top:none; color: #252525; font-size: 28px; font-family: Montserrat; font-weight: 700;"
