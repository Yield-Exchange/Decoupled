                        ...
                        <div class="col-sm-12">
                            <table class="table">
                                ...
                                <tr class="table-active">
                                    <td colspan="2" class="my_h"><span class="b_b">REP</span>ORT <span class="badge bg-blue badge-pill total_records_pill"></span></td>
                                    <td>
                                        <form method="post" action="#" autocomplete="off" class="row">
                                            <label class="col-sm-2 text-right"><br/>Date&nbsp;From:</label>
                                                <input type="text" class="form-control col-sm-3 date_picker" id="date_from" name="date_from" value="" /><br/>
                                            <label class="col-sm-2 text-right"><br/>Date&nbsp;To:</label>
                                                <input type="text" class="form-control col-sm-3 date_picker1" id="date_to" name="date_to" value=""/>
                                            <button type="button" class="btn btn-primary col-sm-1 inline-block btn-sm filterBtn" name="filter" style="margin-left:2%; font-size: 13px"> <i class="fa fa-filter"></i> Filter</button>
                                        </form>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <button type="submit" class="btn bg-grey-300 exportBtn" name="filter" style="margin-left:2%;">
                                            <span class="badge bg-blue badge-pill"></span> <i class="fa fa-download"></i> Export Pdf</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            let table = $('.custom-data-tables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:"{{route('depositor.reports-data')}}",
                    data : function(d){
            ...
            $(document).on('click','.exportBtn',function (e) {
                ...
                window.location.href="{{route('depositor.reports-data')}}?date_from="+$("#date_from").val()+"&date_to="+$("#date_to").val()+"&export=true";
            });
        });
    </script>
