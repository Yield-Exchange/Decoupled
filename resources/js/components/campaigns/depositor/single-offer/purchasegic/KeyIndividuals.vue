<template>
    <div class="w-100 d-flex flex-column justify-content-end">
        <div class="w-100 d-flex flex-column justify-content-center bg-white align-items-center p-4">
            ...
            <p class="kyc-sub-title p-0 m-0 d-none">Finish your profile in 10 minutes and make investing seamless. Your
        ...
        <div class="w-100 d-flex justify-content-end mt-3 gap-2">
            <CustomSubmit @action="goNext" :outline="true" title="Previous" />
...
import Checkbox from '../../../../auth/signup/shared/Checkbox.vue';
...
export default {
    ...
    mounted() {
        ...
        if (this.isedit) {
            ...
            this.disabled = true
            this.jobTitle = this.getLoggedInUser.job_title
        }
    ...
    methods: {
        ...
        goNext() {
            if (this.isedit) {
                ...
                this.$emit('setCurrentStep', 'summarysection')
            }
            else
                this.$emit('setCurrentStep', 'summarysection')
        }
