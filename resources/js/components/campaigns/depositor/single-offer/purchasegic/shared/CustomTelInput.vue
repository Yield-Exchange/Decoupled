<template>
    <div class="w-100 d-flex flex-column">
        ...
        <vue-phone-number-input :error="!numberValididty" :value=inputValue @update="countryChanged" @input="onValueChanged"
            :required="required" class="mynumber" v-model="inputValue" :only-countries="['CA']"
            :preferred-countries="['CA']" default-country-code="CA" style="border-radius:999px !important" color="#252525"
            error-color="#F04438" />
...
export default
    {
        props: ['input_type', 'label', 'currentValue', 'placeholder', 'required', 'tooltip', 'tooltiptitle', 'value', 'disabled', 'isemptycheck'],
        data() {
            return {
                error: false,
                errorMessage: null,
