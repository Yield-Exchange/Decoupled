<template>
    <div style="width: 100%; display:flex; flex-direction:column;">
        ...
        <div style="width: 100%">
            ...
            <Table v-if="hideAllActions" @reloadData="getData()" :columns="columns" no-data-title="No Active Depositors"
                ...
                @selectedItems="getSelectedItems" :select_all="select_all" />
            <Table v-else @reloadData="getData()" :columns="columns" no-data-title="No Active Depositors"
                no-data-message="No Active Depositors" :data="table_data" :has_action='false' :actions='actions'
                @productDeletedAddNew="$emit('productDeletedAddNew')" :selectable="selectable"
                :selected_items="selected_items" :allselectable="(allselectablee) ? true : false"
                :select_all="select_all" @selectedItems="getSelectedItems" />
        </div>
...
<script>
    ...
    import ViewDepositor from "./ViewDepositor";
