    ...
    <div style="width:100%;overflow-x:auto; overflow-y:hidden; ">
        <div class="target-depositor-container" style="width:100%; padding-right: 1rem !important;">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        <div
                            ...
                            <div
                                ...
                                Select The Depositors You Want To Invite To The Campaign.</div>
                        </div>
                    </div>
            ...
            <div style="width: 100%; height:533px; overflow-y:scroll; padding ">
                ...
                <EditDepositorsList :campData="camapign_data" :hideView="true" :hideAllActions="true"
                    :allselectablee="true" :selectable="true" @selectAllR="selectAllR"
...
<script>
    ...
    export default {
        ...
        props: ['depositors', 'has_navigation', 'data', 'collected_details_data', 'selectable', 'selected_groups', 'typeOfInvite'],
        data() {
        ...
        methods: {
            ...
            backToCampaign() {
                ...
                if (urlParams.has('isDraft')) {
                    ...
                    var newParams = `isDraft=1&steps=${newEditableSteps}`;
