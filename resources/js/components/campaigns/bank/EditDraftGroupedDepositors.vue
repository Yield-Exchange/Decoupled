    ...
    <div style="width:100%;overflow-x:auto; overflow-y:hidden; ">
        <div class="target-depositor-container" style="width:100%; padding-right: 1rem !important;">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <b-form-checkbox :id="'checkbox-all-depositors'"
                                                        ...
                                                        @change="toggleSelectAllDepositors" />
                                                    Depositors ({{ displayableGroupDepositors.length }})
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div v-bind:class="((groups_selected.includes(group.id))) ? 'active-group' : ''"
                                                            ...
                                                            <div
                                                                ...
                                                                <EditGroup :group="group" @group_updated="getGroups" />
                                                                <div @click="deleteGroupInit(group.id)">
                                                    ...
                                                    <div v-for="(depositor, index) in group.depositors"
                                                        ...
                                                        <div
                                                            ...
                                                            <div style="width: 18%; height: 100%;">
                                                                <div @click="showConfirmRemoveOrg(depositor, group)"
            ...
            <OKButtonActionMessageBoxVue :size="successModalSize" :title="successModalTitle" :showm="showSuccessModal"
                @okClicked="backToCampaign" @closedSuccessModal="backToCampaign" />
...
<script>
    ...
    export default {
        ...
        props: ['depositors', 'has_navigation', 'data', 'selectable', 'selected_groups', 'typeOfInvite'],
        data() {
            let group_ids = [];
            ...
            console.log(group_ids, "group_idsgroup_ids");
