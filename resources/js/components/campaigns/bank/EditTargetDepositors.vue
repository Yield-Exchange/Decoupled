<template>
    <div style="width:100%;overflow-x:auto; overflow-y:hidden; ">
        <div class="target-depositor-container" style="width:100%; padding-right: 1rem !important;">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        <div
                            ...
                            <div
                                ...
                                Select The Groups You wish to Invite To the Campaign</div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="width: 20%;min-width: 300px;">
                        <div class="d-flex flex-column">
                            <b-button @click="addOrgs()" class="btn-add-group">
                                <span
                                    style="display: flex; flex-direction: row; justify-content: space-between; align-content: center;">
                                    Add Org
            ...
            <div style="margin-top: 55px; margin-bottom: 7px;">
            ...
            <OKButtonAddingMembersActionMessageBoxVue :size="successModalSize" @closedSuccessModal="showSuccessModal1=0"
                :title="successModalTitle" :showm="showSuccessModal1" @okClicked="showSuccessModal1=0" />
...
<script>
    ...
    import OKButtonAddingMembersActionMessageBoxVue from "../../shared/messageboxes/OKButtonActionMessageBox.vue";
    ...
    export default {
        mounted() {
            ...
            this.refreshDisplayableDepositors(this.groups_selected);
        },
        components: {
            OKButtonAddingMembersActionMessageBoxVue,
        ...
        props: ['depositors', 'has_navigation', 'data', 'selectable', 'selected_groups', 'multstepEdit'],
        data() {
            let group_ids = [];
        ...
        methods: {
            ...
            async gotoNextStepoToNextEditStep() {
                let allSelected = [];
                if (this.groups_selected) {
                    this.groups_selected.forEach((e) => {
                        let p = e?.fi_campaign_group_id;
                    ...
                    .then(response => {
                        ...
                        if (response?.data?.success) {
                            ...
                            if (this.multstepEdit) {
                                this.gotoNextStepoToNextEditStep();
                            } else {
                                this.successModalTitle = "Campign Target Depositors Captured"
