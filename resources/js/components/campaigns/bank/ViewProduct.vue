...
<script>
    ...
    export default {
        ...
        methods: {
            viewSummary(){
                window.location.href='/campaigns/products-summary/'+this.actionId;
            }
        },
        props:['actionId']
    }
