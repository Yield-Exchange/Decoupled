<template>
    <div style="width:100%;overflow-x:auto; overflow-y:hidden; ">
        <div class="target-depositor-container" style="width:100%; padding-right: 1rem !important;">
            ...
            <div style="width: 100%; height:533px; overflow-y:scroll; padding ">

                <AddDepositorsList :campData="collected_details_data" :depositors="depositors" :hideView="false"
                    :hideAllActions="false" :allselectablee="true" :selectable="true" @selectedItems="selectedItems"
                    @selectAllR="selectAllR" @selectedOrganizations="setSelectedOrganizations($event)"
                    :selected_items="selected_organizations" :select_all="select_all"
                    @selectAllUpdated="selectAllUpdated" @listOfAllDepostors="setDepositorsCount" />
...
<script>
    ...
    import AddDepositorsList from "./AddDepositorsList";
    ...
    export default {
        ...
        props: ['depositors', 'has_navigation', 'data', 'collected_details_data', 'selectable', 'selected_items', 'typeOfInvite'],
        data() {
            ...
            return {
                ...
                select_all: false,
                selected_organizations: (this.selected_items != null) ? this.selected_items : [],
        ...
        methods: {
            ...
            selectAllGroups() {
                ...
                //  axios.get(`/campaigns/fi/get-all-depos-ids`)
                //    .then(response => {
                //      this.selected_organizations = response?.data;
                //    this.$emit("selectedOrganizations", response?.data);
                //       console.log(response?.data, "selected items");
                // }).catch(error => {
            ...
            setSelectedOrganizations(organizations) {
                // console.log(organizations, "Selected");
                this.selected_organizations = [...new Set(organizations)];
            ...
            proceedToNext() {
                this.$emit('selectedOrganizations', this.selected_items);
            ...
            selectGroups(newValue) {
                ...
                //     // this.groups_selected.push(newValue);
                // } else {
                //     console.log(newValue, "unselection");
                //     // Checkbox unchecked
                //     newValue = Math.abs(newValue);
                //     if (this.open_group === newValue) {
                ...
                // this.$emit('selectedGroups',this.groups_selected);
            },
            searchGroup() {
            ...
            loadAllProvinces() {
                ...
                axios.get("/get-all-provinces", {
                    ...
                    console.log(response?.data, "all provinces");
