<template>
    <div
                    ...
                    <tr v-if="getCampaignSelectedProducts"
                        ...
                        <td>
                            ...
                            <div class="error-message"
                                v-if="((fieldErrors[`rate_${selected_product.product_id}`]) ||(fieldErrors[`minimum_${selected_product.product_id}`]) ||(fieldErrors[`maximum_${selected_product.product_id}`]))">
                        ...
                        <td>
                            ...
                            <CustomInput inputType="number"
                                ...
                                input-type="number"
                                :defaultValue="getProductMinimum(getProductInfo(selected_product.product_id))"
                        ...
                        <td>
                            ...
                            <CustomInput inputType="number"
                                ...
                                input-type="number"
                                :defaultValue="getProductMaximum(getProductInfo(selected_product.product_id))"
        ...
        <OKButtonActionMessageBox :size="successModalSize" @closedSuccessModal="closeSuccessModal"
            :title="successModalTitle" :showm="showSuccessModal" @okClicked="closeSuccessModal" />
...
<script>
    ...
    export default {
        ...
        props: ['selected_products', 'data', 'collected_details_data', 'selected_groups', 'doNotUseBackendProducts', 'multstepEdit', 'depos_count'],
        data() {
            ...
            return {
                forcedDraftEdit: urlParams.has('isDraft') ? true : false,
        ...
        methods: {
            ...
            closeSuccessModal() {
                ...
                if (urlParams.has('isDraft')) {
                    ...
                    this.forcedDraftEdit = true;
                    this.editableSteps = urlParams.get('steps').split(",");
                    let newEditableSteps = this.editableSteps.filter(item => item !== 'campaign_products');
            ...
            previousBtn() {
                ...
                if (products__) {
                    ...
                    if (urlParams.has('isDraft')) {
                        ...
                        this.$emit("updateDoNotUseBackendProductts");
                        this.$emit('enableSection', "editCamapaignProducts");
                    } else {
                        this.$emit("updateDoNotUseBackendProductts");
                        this.$emit("collected_rates", products__);
            ...
            submitRates() {
                ...
                if (products__) {
                    ...
                    axios.post('/campaigns/fi/update-campaign', {
                        ...
                        'products': products__,
                        'campaign': (this.forcedDraftEdit) ? this.data?.id : campaign_id,
                        'forcedDraftUpdate': this.forcedDraftEdit,
                        // 'groups': allSelected
                    })
                        .then(response => {
