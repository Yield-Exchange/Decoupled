            ...
            deleteIt(){
                ...
                axios.post("/campaigns/fi/my-campaigns/delete-campaign",{
                    ...
                    if(response?.data?.success) {
                        ...
                        this.deleteStep = 2;
                        this.deleting_submitted = true;
                        window.location="/campaigns/drafts";
                    }else{
