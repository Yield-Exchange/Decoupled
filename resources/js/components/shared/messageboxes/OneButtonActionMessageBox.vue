<template>
    <b-modal :size="size" v-model="visible" hide-footer hide-header centered id="twobtnactionx"
        ...
        <b-container class="bv-example-row" style="width: 100% !important;padding: 0px !important;">
            ...
            <b-row style="width:100%;padding: 0px !important;">
                <b-col md="12" class="mt-2 ml-5"
                    style="width:100%;padding: 0px !important; margin-left:50px !important;">
                    <div class="text-div pl-2" style="font-family: Montserrat;
                    font-size: 18px;
                    font-weight: 500;
                    line-height: 23px;
                    letter-spacing: 0em;
            ...
            <b-row style="width:100%; padding: 0px !important;margin-top: 0px;">
                <b-col md="6" style="padding: 10px; padding-right: 4px; !important;">

                    <div v-if="showokbtn" style="display: flex; align-items: center; justify-content: end;">

                        <b-button @click="$emit('btnOneClicked')"
                            style="width: 80% !important; height: 40px !important;padding: 10px, 30px, 10px, 30px !important;border-radius: 20px !important;border: 2px #5063F4 solid !important;background-color: white !important;color: #5063F4 !important;">
                            {{btnOneText}}
                        </b-button>
                    </div>
                </b-col>
                <b-col md="6" style="padding: 10px; padding-right: 4px; !important;">
                    ...
                    <div v-if="showokbtn" style="display: flex; align-items: center; justify-content: end;">
                        ...
                        <b-button @click="$emit('btnTwoClicked')"
...
<script>
    ...
    export default {
        ...
        props: ['title', 'message', 'show', 'size', 'btnOneText', 'btnTwoText', 'titlespan', 'showokbtn'],
        computed: {
            visible() {
                return this.show;
            }
