<template>
    <b-modal :size="size" v-model="visible" hide-footer hide-header centered :no-close-on-backdrop="true">
        <b-container class="bv-example-row"
            style="width: 100% !important;padding: 0px !important; padding:0px 0px 30px 0px;">
            ...
            <b-row style="width:100%;padding: 0px !important;">
                <b-col md="12" style="width:100%;padding: 0px !important;">
                    <MessageHeaderIconized :title="title" width="100"
                        title_image="/assets/dashboard/icons/Promo-1.svg" />
                </b-col>
            </b-row>
            <b-row style="width:100%;padding: 0px !important; margin-top: 5px;">
                <b-col md="12" class="align-items-center" style="width:100%;padding-left:0px !important;">
                    <div class="message-body" style="margin-left: 70px;">{{ message }}</div>
                </b-col>
            </b-row>
            <b-row v-if="showaction" style="width:100%;padding: 0px !important;margin-top: 5px;">
                <b-col v-if="showaction" md="12" class="d-flex justify-content-end align-items-center"
                    style="width:100%;padding: 0px !important;">
                    <b-button @click="closeModal()" class="btn message-action-btn-solid">
                        Previous
                    </b-button>
                </b-col>
            </b-row>
...
<script>
    ...
    export default {
        ...
        props: ['title', 'message', 'show', 'size', 'showaction'],
        computed: {
            visible() {
                return this.show;
            }
        ...
        methods: {
            closeModal() {
                this.$emit('cancelled', 'Message Closed');
                this.$emit('closedModal', 'Message Closed');
