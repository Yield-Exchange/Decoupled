<template>
    <b-modal :size="size" v-model="visible" hide-footer hide-header centered id="twobtnaction"
        ...
        <b-container class="bv-example-row" style="width: 100% !important;padding: 0px !important;">
            ...
            <b-row style="width:100%;padding: 0px !important;">
                <b-col md="12" style="width:100%;padding: 0px !important;">
                    <MessageHeaderIconized :title="title" :titlespan="titlespan" width="100"
                        title_image="/assets/dashboard/icons/Promo-1.svg" />
                </b-col>
            </b-row>
            <!-- <b-row style="margin-top: 30px; width: 100%; padding: 0px !important; margin-top: 30px;">
                <b-col md="12" class="align-items-center text-center" style="width: 100%; padding: 0px !important;">
            ...
            <b-row style="width:100%; padding: 0px !important;margin-top: 15px;">
                <b-col md="6" style="padding: 10px;padding-right: 4px; ">
...
<script>
    ...
    export default {
        ...
        props: ['title', 'message', 'showm', 'size', 'btnOneText', 'btnTwoText', 'titlespan', 'showokbtn'],
        computed: {
            visible() {
                return this.showm;
            }
