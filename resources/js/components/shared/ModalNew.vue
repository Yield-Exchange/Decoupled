<template>
    <b-modal :size="size" v-model="visible" hide-footer hide-header centered dialog-class="custom-modal"
        id="campaign_modal" :no-close-on-esc="true">
        <b-container class="bv-example-row" style="width: 100% !important;padding: 0px !important;  ">
            <b-row style="width:100%;padding: 0px !important;">
                <b-col md="12 " class="d-flex justify-content-end " style="width:100%;padding: 0px !important;">
                    <svg xmlns="http://www.w3.org/2000/svg" @click="closeModal()" width="31" height="31"
        ...
        <LeavePageConfirmDialog size="md" btnOneText="Stay" btnTwoText="Leave"
            title="Are You Sure You want to leave this Page?" :showm="showLeaveWarning" @stayOnPage="stayOnPage()"
...
<script>
    ...
    export default {
        props: ['show', 'modalHeight', 'hide_close', 'confirm_close_modal', 'modalWidth', 'size'],
        components: {
