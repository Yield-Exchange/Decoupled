    ...
    <div ref="parentWidth"
        ...
        <div style="justify-content: flex-start; align-items: flex-start; gap: 11px; display: flex">
            <FilterDropdown @clear_filters="clearFilters" :provinces="provinces" :products="products"
                ...
                :filtered_item="extraFilter" :fiorganizations="fiorganizations" ref="filterDropdownRef" :from="from">
            </FilterDropdown>
        </div>
        <div
            style="width: 280px; padding-left: 16px;  padding-bottom: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex;cursor: pointer">
...
<script>
    ...
    import FilterDropdown from "./ReviewFilterDropdown.vue";
    ...
    export default {
        ...
        props: ['filtered', 'provinces', 'products', 'filterType', 'industries', 'fiorganizations', 'from'],
        data() {
