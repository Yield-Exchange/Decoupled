            ...
            <td v-for="(datum1, index1) in slicedData(datum)" :key="'TableData' + index1">
                <template v-if="selectable && index1 === 0">
                    <b-form-checkbox :id="'checkbox-' + index" name="checkbox-1" class="checkbox-select-table"
                        ...
                        :checked="(getCampaignSelectedProductIDS && getCampaignSelectedProductIDS.includes(datum1)) ? datum1 : null" />

                </template>
                <template v-if="typeof datum1 === 'function'">
            ...
            <td v-if='has_action'>
                <Actions>
                    <b-dropdown-item v-on:click="() => false" href="#"
                        ...
                        <component :actionId="data[index][0]" :actionObjectDetails="data[index]" :is="action.component"
                            v-bind="action.attrs">{{ action.name }}
                        </component>
                    </b-dropdown-item>
                </Actions>
            </td>
