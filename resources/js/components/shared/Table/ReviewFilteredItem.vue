<template>
    <div ref="filteredItemref" style="justify-content: flex-start; align-items: flex-start; gap: 11px; display: flex">
        <div class="selected-filter"> <span> {{ formatLabel(statusText) }} </span>
        ...
        methods: {
            ...
            getMinMax(value) {
                ...
                if (this.title.toLowerCase() != 'products') {
                        ...
                        if (i == 1 && element != 0 && element != null) {
                            ...
                            if (this.statusText != null && element != 0 && element != null) {
                                if (this.title.toLowerCase() == "termlength") {
                                    ...
                                    this.statusText = addCommasToANumber(this.minvalue) + " - " + addCommasToANumber(element)
                                }
                    ...
                    value.forEach(element => {
                        console.log(element, "request_amount")
