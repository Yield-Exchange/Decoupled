...
import ViewActiveOffers from './actions/ViewActiveOffer.vue';
...
export default {
    ...
    data() {
        let columns = ['GIC No', 'Depositor', 'Deposit Amount', 'Product', 'Term length', 'Rate', "Maturity Date", "Action"]
        let action = [
            {
                name: "View",
    ...
    methods: {
        ...
        getData(url) {
            ...
            let pendingdeposits = []
            let getpath = url ? url : "/bank-active-deposits-data-new"
        ...
        applyFilters(value) {
            let url = '/bank-active-deposits-data-new?'
