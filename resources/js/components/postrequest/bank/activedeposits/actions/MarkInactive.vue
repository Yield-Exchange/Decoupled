<template>
    <div>
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="markinactive = false" @btnTwoClicked="withDrawDeposit"
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="success = false" @btnTwoClicked=""
            @btnOneClicked="success = false" icon="/assets/signup/success_promo.svg" title="Deposit Marked as inactive"
...
export default {
    ...
    methods: {
        ...
        withDrawDeposit() {
            ...
            axios.post('/mark-deposits-inactive/' + this.actionId, { 'dep_id': this.actionId, 'reason': this.reason }).then(response => {
        ...
        getReasons() {
            axios.get('/bank-inactivation-reasons').then(response => {
