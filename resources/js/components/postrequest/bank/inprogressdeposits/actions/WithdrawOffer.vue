<template>
    <div>
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="uploadShow = false" @btnTwoClicked="upload"
            @btnOneClicked="uploadShow = false" icon="/assets/dashboard/icons/question-new.svg"
            title="Do you want to withdraw this offer??" :showm="uploadShow" btnOneText="Cancel" btnTwoText="Withdraw Offer">
            <div class="ml-5 description-text-withdraw">
                <CustomSelectInput label="Reason for withdrawing the offer" :options="options"
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="success = false" @btnTwoClicked=""
            @btnOneClicked="success = false" icon="/assets/signup/success_promo.svg" title="Offer Withdraw"
            btnOneText="" btnTwoText="" :showm="success">
            <div class="ml-5 description-text-withdraw ">Your offer will no longer be
                available to all Depositors.</div>
        </ActionMessage>
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="fail = false" @btnTwoClicked=""
            ...
            title="Deposit not inactivated!" :showm="fail">
...
export default {
    ...
    components: {
        TableActionButton, ActionMessage,CustomSelectInput
    },
    data() {
        return {
            uploadShow: false,
    ...
    methods: {
        ...
        getWithdrawReasons(){
           axios.get('/get-withdraw-offer-reasons').then(response=>{
        ...
        upload() {
            ...
            axios.post('/offer-withdraw/' + this.actionId, { 'offer_id': this.actionId, 'reason': this.reason }).then(response => {
