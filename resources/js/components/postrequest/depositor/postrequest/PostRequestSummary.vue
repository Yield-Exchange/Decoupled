<template>
    <div>
            ...
            <div
                ...
                <div style="justify-content: space-between; display: inline-flex; width: 99%">
                    <div class="page-title">
                        ...
                        <div class="text-div">Request Summary {{ count + 1 }}</div>
                    </div>
        ...
        <div class="d-flex gap-4 flex-wrap mt-3 p-3" v-if="reqsummary">
            <ViewCard title="Product" :desc="reqsummary.product" />
            <ViewCard title="Term Length"
                :desc="reqsummary.term_length == null ? '-' : reqsummary.term_length + ' ' + reqsummary.term_type" />
            <ViewCard title="Lockout Period"
                :desc="reqsummary.lockout_period == null ? '-' : reqsummary.lockout_period" />
            <ViewCard title="Requested Amount"
                :desc="reqsummary.deposit_currency + ' ' + addCommas(reqsummary.deposit_amount)" />
            <ViewCard title="Approximate Date of Deposit"
                :desc="reqsummary.date_of_deposit == null ? '-' : formatDateToCustomFormat(reqsummary.date_of_deposit, false)" />
            <ViewCard title="Compounding Frequency"
                :desc="reqsummary.compound_frequency == null ? '-' : reqsummary.compound_frequency" />
            <ViewCard title="Short Term Credit Rating"
                :desc="reqsummary.credit_rating == null ? '-' : reqsummary.credit_rating" />
            <ViewCard title="Special Instructions"
                :desc="reqsummary.specinstructions == null ? '-' : reqsummary.specinstructions" />
        </div>
    </div>
