<template>
    <div class="pr-start-chat" @click="goToChat">
...
export default {
    ...
    methods: {
        goToChat() {
            window.location.href = 'summary/request/review_offers/' + null + "/" + this.deposit_id + '?fromPage=depositor-history';
        }
    },
    props: ['deposit_id']
}
...
.pr-start-chat {
    ...
    /* border: 1px solid var(--Yield-Exchange-Colors-Yield-Exchange-Purple, #5063F4); */
}
