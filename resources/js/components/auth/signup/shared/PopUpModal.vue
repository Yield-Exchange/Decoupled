<template>
    <div class="modal fade " :class="show ? 'show' : ''" id="staticBackdrop" data-backdrop="static" data-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
        <div class="modal-dialog modal-dialog-centered d-flex justify-content-center" :style="{ 'maxWidth': width + 'px', }" :class="classess">
            <div class="modal-content signup-pop-padding" style="width: 600px;" :style="{ 'maxWidth': width + 'px !important' }">
