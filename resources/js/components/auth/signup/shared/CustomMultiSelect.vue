<template>
    <div class="w-100 d-flex flex-column">
        ...
        <MultiSelect :class="{ 'custom-input-error ': error }" class="custom-input1" :placeholder="placeholder"
...
export default
    {
        props: ['input_type', 'label', 'placeholder', 'required', 'isemptycheck', 'currentValue', 'options'],
        components: {
            MultiSelect: Select2
        },
        mounted() {
