<template>
    <div class="row" style="width:80%">
        <h4 class="font-weight-bold text-center color-black" style="color: black" v-if="organization.type === 'DEPOSITOR'" > Organization Settings</h4>
                ...
                <div class="card-body" style="padding-top: 20px" id="tooltip_viewpoint">
                    ...
                    <div class="row mt-2">
                        <sign-up-step1 :fromUserProfile="true" :organization-type="this.organization.type"
                                       ...
                                       :show-label="showLabel" ref="Step1"
                                       :digital_account_opening.sync= "digital_account_opening"
