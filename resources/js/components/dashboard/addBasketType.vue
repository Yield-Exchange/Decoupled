...
export default {
    ...
    methods: {
        ...
        setDefaults() {
            this.description = this.product.basket_name
            this.basket_type_desc = this.product.basket_description
        ...
        createProduct() {
            ...
            let action = null
            if (this.action == 'add') {
                url = '/yie-admin/trade/add-new-basket-types'
                action = 'add'
                data = {
                    "basketName": this.description,
                    "basketDescription": this.basket_type_desc,
