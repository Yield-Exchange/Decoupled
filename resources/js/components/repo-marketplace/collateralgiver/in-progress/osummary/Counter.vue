                    ...
                    <div
                        ...
                        <template v-if="false">
                            ...
                            <div
                                ...
                                {{ log_table_data[0][4] }}</div>
                            <div style="width: 128px; height: 0px; border: 0.51px #9CA1AA solid ;margin-top: 20px;">
                            </div>
                            <p class="strike-through" v-if="has_counter">
                        ...
                        <div v-if="false"
                            ...
                            <div
                                ...
                                {{ offer?.c_t_trade_request?.inviter?.name }}
                            </div>
                            <div class="my-2"
                            ...
                            <!-- <div class="my-2 w-100"
                                style=" width: 100%; background-color: #EFF2FE;padding: 5px; color: #252525; font-size: 18px; font-family: Montserrat; font-weight: 700; text-transform: capitalize; line-height: 26px; word-wrap: break-word">
                                Additional Interest Earned: <br> <span style="white-space: nowrap;">{{ selectedCurrency
        + " " +
        addCommas(interestearned) }}</span>
                            </div> -->
                        </div>
                        <ShowRateCard v-if="offer" offer="offer" :rate_type="offer?.rate_type" :counters="offer.counter_offers"
                            ...
                            :requireAction="has_counter" :from_counter="true" :selectedCurrency="selectedCurrency"
                    ...
                    <div class="row w-100 mx-auto px-4 bg-white">
                        ...
                        <div class=" col-12 col-md-12 mb-20">
                            <FormLabelRequired labelText="Investment Amount" required="true" :showHelperText="false"
                                summary='(Enter M for Million, B for Billion)' helperText="Investment Amount"
...
<script>
    ...
    import { addDaysOrMonths, formatTimestamp, calculateIterestOnProduct, addDaysOrMonthsToDate, calculateIterestOnDateCountConnvention } from '../../../../../utils/commonUtils'
    ...
    export default {
        props: ['offerIndex', 'show', 'daycount', 'holidays'],
        beforeMount() {
        ...
        mounted() {
            if (this.offerIndex != null && this.getAllOffersInReview != null) {
                ...
                if (counter_offers.length > 0) {
                    console.log(counter_offers[0].status, 'counter log')
        ...
        methods: {
            ...
            setDefaults() {
                if (this.offer) {
                    ...
                    this.date_of_deposit = offer.settlement_date.split(' ')[0]
            ...
            newInterestCalculations() {
                ...
                this.new_offer_interest_rate = Number.parseFloat(new_offer_interest_rate)
            ...
            doSubmit() {
                ...
                axios.post('/trade/CG/give-counter-offer', data).then(response => {
