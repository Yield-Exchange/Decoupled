                ...
                <b-tabs content-class="mt-3"
                    ...
                    <b-tab title="Active Requests" active>
                        <div class="ml-10 mt-3"
                            ...
                            <FilterBox :filtered="filtered" :dontshow="['tradedate', 'investor']"
                                @apply_filters="submitFilters" @clear_filters="clearFilters" filterType="bank"
                        ...
                        <div class="mt-3">
                            <Table :columns="columns" no-data-title="No Offers" @selectedItems="selectedItems($event)"
                                ...
                                :has_action='false' :allselectable="false" :selectable="selectable"
                                :selected_items="selected_offers" :actions='actions' :is_loading="is_loading" />
                        </div>
                        <div class="mt-3">
                    ...
                    <b-tab title="Matured Requests">
                        <MaturedOffers :timezone="timezone"></MaturedOffers>
                    </b-tab>
                </b-tabs>
            </div>
        </div>
...
import MaturedOffers from "./MaturedOffers.vue";
...
export default {
    ...
    props: ['timezone', 'titlespan', 'userLoggedIn'],
    data() {
    ...
    methods: {
        ...
        async nextStep() {
            if (this.selected_offers && this.selected_offers.length > 0) {
                this.$emit('nextStep')
            } else
        ...
        setOffers() {
            ...
            this.selected_items.forEach(item => {
                ...
                if (found_item) {
                    ...
                    // console.log(found_item, "found item")
