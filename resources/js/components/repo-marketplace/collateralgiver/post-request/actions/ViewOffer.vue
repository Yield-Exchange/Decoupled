<template>
    ...
    <div @click="viewOffersSummary"
        :style="'width:100%;height: 20px; padding: 4px 8px;border-radius: 200px; background: rgb(234, 245, 234);justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex;color: rgb(42, 153, 40); font-size: 13px;  font-weight: 500; line-height: 9px; word-wrap: break-word;cursor: pointer'">
        ...
        <OfferSummary :userLoggedIn="getLoggedInUser" v-if="show" :show="show" :offer="offerDetails"
...
<script>
    ...
    import OfferSummary from "../ossummary/OfferSummary.vue";
