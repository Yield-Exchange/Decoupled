<template>
    <ActivateBasket :actionId="actionId" v-if="activate"></ActivateBasket>
    ...
    <div v-else>
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="success = false" @btnTwoClicked=""
            ...
            title="Basket Archived successfully" btnOneText="" btnTwoText="" :showm="success">
        ...
        <ActionMessage style="width: 600px;" @closedSuccessModal="withdrawalRequest = false"
            ...
            title="Are you sure you want to archive this collateral basket" :showm="withdrawalRequest">
...
<script>
import ActivateBasket from "./ActivateBasket.vue";
...
export default {
    ...
    methods: {
        checkStatus() {
            ...
            if (this.triparty.basket_status == 'ARCHIVED') {
                this.activate = true
            }
            // this.show = true
        },
