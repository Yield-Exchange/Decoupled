<template>
    <div class="w-100 p-4">
            ...
            <div class="col-md-12 mt-3">
                <div class="d-flex justify-content-between gap-2">
                    ...
                    <div class=" d-flex justify-content-end gap-2">
                        <div v-if="!i_initated">
                            <CustomSubmit v-if="accept_cancel" title="Respond" :previous="true"
                                @action="start_cancel = true" />
                            <!-- <CustomSubmit v-else title="Cancel Trade" :previous="true" @action="cancelTrade" /> -->
                        </div>
                        <CustomSubmit title="Chat" :outline="true" @action="show_chat = true" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div style="width: 100%; margin-top: 10px;" class="row mt-3">
                ...
                <b-tabs content-class="mt-3"
                    ...
                    <b-tab :title="'About ' + organization_data?.name" active>
                        <AboutBank v-if="organization_data" :organization_data="organization_data" />
                    </b-tab>
        ...
        <ChatComponent from="CG" :reference="reference" :recipient="organization_data" :deposit_id="deposit_id"
...
import { addDaysOrMonthsToDate, getBasketDetails, calculateIterestOnDateCountConnvention, formatTimestamp, formatNumberAbbreviated, repoProductName, calculateIterestOnProduct, addCommasAndDecToANumber } from '../../../../utils/commonUtils'
...
export default {
    components: { ShowRateCard, ChatComponent, CustomSelect, FormLabelRequired, ActionMessage, InviteCard, ViewCard, AboutBank, Modal, Table, CustomSubmit, Tooltip },
    ...
    methods: {
        ...
        goBack() {
            window.location.href = "/repos/cg-repos-active-trades"
        },
        addCommas(newvalue) {
