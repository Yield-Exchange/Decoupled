        ...
        repoProductName(offer?.offer_term_length, offer?.offer_term_length_type,
            offer?.product?.product_name),
                        ...
                        <div class="d-flex gap-4 flex-wrap mt-2">
                            ...
                            <ViewCard :inverted="true" title="Day Count" :hastooltip="true" id="cga8ddcc"
                ...
                <div style="width: 100%; margin-top: 10px;" class="row mt-3">
                    ...
                    <b-tabs content-class="mt-3"
                        ...
                        <b-tab :title="'About ' + organization_data?.name" active>
                            <AboutCGNoModal :organization="organization_data" />
                        </b-tab>
...
import { formatNumberAbbreviated, repoProductName, addCommasAndDecToANumber, addDaysOrMonths, calculateIterestOnDateCountConnvention, formatTimestamp, getBasketDetails } from '../../../../../utils/commonUtils'
...
export default {
    components: { AboutCGNoModal, ShowRateCard, InviteCard, ViewCard, AboutBank, Modal, Table },
    props: ['offerIndex', 'show'],
    mounted() {
        if (this.offerIndex != null && this.getHistoryOffers != null) {
            let offerobj = this.getHistoryOffers[this.offerIndex]
            this.offer = offerobj
    ...
    computed: {
        ...mapGetters('repopostrequest', ['getHistoryOffers']),
    ...
    methods: {
        ...
        setPageDefaults() {
            // console.log(this.getHistoryOffers)
        },
