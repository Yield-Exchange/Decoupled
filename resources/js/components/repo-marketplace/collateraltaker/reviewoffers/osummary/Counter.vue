                ...
                if (this.spread_rate > 100) {
                    ...
                    if (this.rate_operator === "+") {
                        ...
                        if (sum > 100) {
                            ...
                            if (sum < 0.01) {
                                let minmum = 0.01 + Math.abs(this.spread_rate);
                                this.spreadRateError = `Enter a value equal or greater than ${sum} `;
                            } else {
                                this.spreadRateError = null;
                            }
                        ...
                        var difference = varyrate - Number.parseFloat(varyrate);
                ...
                if (this.rate_type == 'fixed') {
                    ...
                    if (Number.parseFloat(this.spread_rate) > 0 && this.spreadRateError == null) {
                        ...
                        if (Number.parseFloat(this.interest_rate) <= 0) {
                            this.haserror = true
                            this.spreadRateError = this.spreadRateError == null ? "Please enter a valid spread" : this.spreadRateError
                        } else {
                            this.haserror = false;
