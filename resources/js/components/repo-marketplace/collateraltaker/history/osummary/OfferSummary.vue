    ...
    <Modal :show="show" @isVisible="$emit('closeModal', $event)" modalsize="xl" v-if="offer">
        ...
        offer?.product?.product_name }}</h4>
                        ...
                        <div class="d-flex gap-4 flex-wrap mt-2">
                            ...
                            <ViewCard :inverted="true" title="Day Count" :hastooltip="true" id="cgyaddcc"
...
import { addDaysOrMonths, getBasketDetails, formatTimestamp, calculateIterestOnDateCountConnvention, formatNumberAbbreviated, addCommasAndDecToANumber } from '../../../../../utils/commonUtils'
