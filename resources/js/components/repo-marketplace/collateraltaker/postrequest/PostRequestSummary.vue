    ...
    <div>
        ...
        <div class="d-flex gap-4 flex-wrap mt-3 p-3" v-if="reqsummary && viewMore1">
            <ViewCard title="Investment"
                :desc="reqsummary.investment_currency + ' ' + addCommas(reqsummary.investment_amount)" />
            <ViewCard title="Term Length"
                :desc="reqsummary.term_length == null ? '-' : reqsummary.term_length + ' ' + reqsummary.term_type" />

            <ViewCard title="Preferred Collateral">
                <div class="d-flex flex-wrap gap-2">
                    <div class="collateral-item" v-for="item in reqsummary.collateral">{{ item }}</div>
                </div>
            </ViewCard>
            <ViewCard title="Trade Date"
