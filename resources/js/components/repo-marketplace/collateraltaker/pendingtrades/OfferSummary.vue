        ...
        <div class="row my-2" v-if="offer">
            <div class="col-md-4 col-lg-3">
                <ShowRateCard :rate_type="offer?.rate_type" :rate_operator="offer?.rate_operator"
                    ...
                    :variable_rate_value="offer.variable_rate_value" :needsRespond="accept_cancel"
                    :requireAction="false" :hasCounters="hasCounters">
                </ShowRateCard>
            </div>
                    ...
                    <div class=" d-flex justify-content-end gap-2">
                        <template v-if="userCan(userLoggedIn, 'depositor/repos/adjust-repo')">
                            <div v-if="accept_cancel && !i_initated">
                                <CustomSubmit v-if="accept_cancel" title="Respond Cancellation" :outline="true"
...
export default {
    components: { ShowRateCard, AboutCGNoModal, Adjustment, ChatComponent, CustomSelect, FormLabelRequired, ActionMessage, InviteCard, ViewCard, AboutBank, Modal, Table, CustomSubmit },
    ...
    methods: {
        ...
        setPageDefaults() {
            if (this.deposit != null) {
                ...
                this.maturity_date = formatTimestamp(this.deposit?.trade_date, false)
