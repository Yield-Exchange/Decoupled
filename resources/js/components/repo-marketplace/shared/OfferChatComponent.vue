...
export default {
    props: ['offer_id', 'recipient', 'sender', 'show', 'from', 'reference'],
    ...
    methods: {
        ...
        sendMessage() {
            ...
            data.append('offerId', this.offer_id)
            data.append('message', this.newMessage)
            if (this.fileToUpload)
                data.append('file', this.fileToUpload)
            let url = null
            if (this.from == 'CG')
                url = '/trade/CG/send-offer-message'
            else
                url = '/trade/CT/send-offer-message'
        ...
        getMessages() {
            let url = null
            if (this.from == 'CG')
                url = '/trade/CG/get-offer-messages?offerId=' + this.offer_id
            else
                url = '/trade/CT/get-offer-messages?offerId=' + this.offer_id
    ...
    created() {
        ...
        Echo.private("CT_Trade_Request_offer_chat." + this.reference).listen(
            "CTTradeRequestOfferChatEvent",
            (e) => {
                this.getMessages()
            }
        );
