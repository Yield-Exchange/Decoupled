                        ...
                        <br />
                           ...
                           <br /><br />
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-3">
                                 <button onclick="window.location.href='p_req'" style="border:1.5px solid gainsboro" class="btn btn-block">Edit</button>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-3">
                                     <button onclick="window.location.href='logic?confirm_all=all'"  class="btn mmy_btn btn-primary btn-block">Submit</button>
                                </div>
...
<script>
    $(document).on('click','a',function (e) {
        if ( !$(this).hasClass("no-page-exit-alert") ) {
            ...
            swal({
                title: "Are you sure?",
                text: "Are you sure you want to leave this page? Your request changes won't be saved!",
                icon: "warning",
                buttons: ["No", "Yes"],
            }).then((response) => {
                if (response) {
    ...
    $(document).on('click','.cancel-request',function (e) {
        ...
        swal({
            title: "Are you sure?",
            text: "You are about to cancel this request, would you wish to proceed?",
            icon: "warning",
            buttons: ["No", "Yes"],
        }).then((response) => {
            if (response) {
                window.location.href='logic?reset_values=1';
