                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7"><span style="font-weight:bold"><?php echo Core::render($offer["reference_no"]); ?></span></div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <span style="font-weight:bold">
                                                                <?php
                                                                echo Core::render($data["currency"]) ." ".number_format($data['amount']);
                                                                ?>
                                                            </span>
                                                        </div>
                                                    </div>
