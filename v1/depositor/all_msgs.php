...
if ( AuthModel::isLoggedIn() ){
    ...
    Core::activityLog("Depositor all messages");

    $user_id = $user_data['id'];
    $data=BankModel::getBanks();

    $sql="SELECT c.*,i.invited_user_id FROM `deposits` c, `offers` o, `invited` i, `depositor_requests` dr WHERE i.id=o.invitation_id AND o.id=c.offer_id AND dr.id=i.depositor_request_id AND dr.user_id='$user_id'";
