...
if( AdminModel::isLoggedIn() ){
    ...
    Core::activityLog("admin view non invited fi");
    ?>
    <style>
        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    ...
                    <span class="breadcrumb-item active">Non-Invited FI List</span>
                </div>
                                ...
                                <table class="table datatable-basic dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    ...
                                    if(!empty($data)){
                                        ...
                                        foreach($data as $rec){
                                            ...
                                            $user = AuthModel::getUserDataByID($user_id);
                                            $invited_by = AuthModel::getUserDataByID($rec['created_by']);
                                            ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h6 class="mb-0"><?php echo Core::render($rec['account_manager']); ?></h6>
                                                </td>
                                                <td>
                                                    <h6 class="mb-0"><?php echo !empty($rec['inviter_name']) ? Core::render($rec['inviter_name']).' from' : ''; ?>
                                                        <br/> <?php echo Core::render(@$invited_by['name']); ?>
                                                    </h6>
                                                </td>
                                                <td><?php echo Core::render($demographic_data['city']); ?></td>
                                                <td class="">
                                                    <h6 class="mb-0"><?php echo Core::render($user['email']); ?></h6>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    switch ($status){
                                                        case "ACTIVE":
                                                            ...
                                                            break;
                                                        default:
                                                            if ( in_array($status,['REVIEWING','INVITED']) ) {
                                               ...
                                               <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="edit_user?id=<?php echo Core::urlValueEncrypt($rec['id']);?>&&page=list_bank">Edit</a>
                                                            <?php
