...
if( AdminModel::isLoggedIn() ){
    ...
    $sql_.=" AND rt.description='Broker' AND u.account_status IN('ACTIVE','LOCKED','SUSPENDED','CLOSED')";
    ...
    Core::activityLog("admin view approved brokers");
?>
    <style>
                                                ...
                                                ?>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="edit_user?id=<?php echo Core::urlValueEncrypt($rec['id']);?>&&page=list_brokers">Edit</a>
                                                            <?php
