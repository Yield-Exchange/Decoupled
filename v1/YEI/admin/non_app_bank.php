...
require_once("sidebar.php");
    ...
    $sql_.=" AND rt.description='Bank' AND u.account_status IN('PENDING')";
				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<a href="index.php" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a>
							<span class="breadcrumb-item active">Non Approved Banks</span>
					</div>
								...
								<table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr class="table-active table-border-double">
											<td colspan="3">Non Approved Banks</td>
											<td class="text-right">
								...
								<table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
									 <thead>
										<tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">ST DBRS</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Deposit Insurance: activate to sort column ascending">Deposit Insurance</th>
                                            <th>Status</th>
										</tr>
									</thead>
									<tbody>
                                            ...
                                            <td class=" ">
                                                <h6 class="mb-0"><?php echo $demographic_data['address']; ?></h6>
                                            </td>
                                        	<td><?php  echo Core::render($demographic_data['city']); ?></td>
                                            <td><?php  echo Core::render($demographic_data['telephone']); ?></td>
                                            <td>
                                                <?php echo Core::render($ratings['credit_rating']);?>
                                            </td>
                                            <td><?php echo Core::render($ratings['deposit_insurance']);?></td>
                                            <td class="text-center">
                                                <?php
                                                if( $rec['account_status'] !== "PENDING" ) {
                                                ?>
                                                    <a href="logic?id=<?php echo Core::urlValueEncrypt($rec['id']); ?>&&action=approve" class="btn btn-primary">Approve</a>
                                                <?php
                                                }
                                                ?>
                                            </td>
