...
if( AdminModel::isLoggedIn() ){
    ...
    $sql_.=" AND rt.description='Bank' AND u.is_non_partnered_fi=0"; /*AND u.account_status IN('ACTIVE','LOCKED','SUSPENDED','CLOSED') AND */
    ...
    Core::activityLog("admin view approved banks");
?>
        <style>
				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<a href="index.php" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a>
							<span class="breadcrumb-item active">Banks List</span>
					</div>
