...
require_once("sidebar.php");
    ...
    if(isset($_GET['cnid'])){
        ...
        if (!empty($contract_data)){
            ...
            Core::activityLog("admin view contract details");
?>
                           ...
                           <div class="row">
                               ...
                               ?>
                                <div class="col-sm-2 col-4">
                                    <img src="../depositor/image/<?php echo $depositor_data['profile_pic']; ?>" style="max-height:100px;max-width: 100%"/>
                                </div>
                              ...
                              <div class="col-lg-11 col-md-11 col-sm-11">
                                  <div class="row" style="margin-left:10px">
                                      <div class="col-lg-2 col-md-2 col-sm-2">
                                        <a href="active_contracts" class="btn btn-block" style="border:1px solid gainsboro" style="color:white" >Back</a>
                                      </div>
                                  </div>
                                </div>
