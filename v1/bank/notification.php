...
if( AuthModel::isLoggedIn() ){
    ...
    Core::activityLog("Bank View Notifications");
                            ...
                            <div class="col-12">
                                ...
                                if(!empty($rec))
                                {
                                    foreach($rec as $re)
                                    {
                                        ...
                                        $sent_by_demographic_user_data = AuthModel::getUserDemographicData($re['sent_by']);
                                ?>  <tr>
                                            <td>
                                                <h6 class="mb-0"><?php echo !empty($sent_by) ? Core::render($sent_by["name"]) : ''; ?></h6>
                                            </td>
											<td>
												<h6 class="mb-0"><?php echo !empty($sent_by) ? Core::render($sent_by_demographic_user_data["province"]) : ''; ?></h6>
											</td>
											<td>
												<h6 class="mb-0">
                                                    <?php  echo $re['details']; ?>
