...
if (AuthModel::isLoggedIn()) {
    ...
    Core::activityLog("Bank Reports");
    $contracts = BankModel::getBankCompletedContractsReports($user_data['id'],@$_POST['date_from'],@$_POST['date_to']);
                                ...
                                ?>
                                        <tr>
                                            <td class="hidden" style="display:none;">
                                                <div>
                                                    <h6 class="mb-0" ><?php echo $contract["id"]; ?></h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <h6 class="mb-0"><?php echo $contract["reference_no"]; ?></h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <h6 class="mb-0"><?php echo $contract["gic_number"]; ?></h6>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 class="mb-0">
                                                    <?php
                                                        $depositor_data = AuthModel::getUserDataByID($contract["user_id"]);
                                                        echo $depositor_data['name'];
                                                    ?>
                                                </h6>
                                            </td>
                                            <td>
                                                <h6 class="mb-0">
                                                    <?php
                                                        $depositor_data = AuthModel::getUserDemographicData($contract['user_id']);
                                                        echo Core::render($depositor_data['province']);
                                                    ?>
                                                </h6>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <h6 class="mb-0"><?php
                                                         if ($contract['term_length_type'] == "HISA"){
                                                             echo '-';
                                                         }else {
                                                             echo Core::render($contract['term_length'].' '.strtolower($contract['term_length_type']));
                                                         }?></h6>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td data-order="<?php echo $contract["amount"];?>">
                                                <h6 class="mb-0">
                                                    <?php
                                                        echo $contract['currency'].' '.number_format($contract['amount']);
                                                    ?>
                                                </h6>
                                            </td>
                                            <td>
                                            ...
                                            <td style="border-right:0">
                                                <h6 class="mb-0">
                                                    <?php echo Model::dateTimeFromUTC('Y-m-d',$contract['gic_start_date'],$bank_demographic_data['timezone']); ?>
                                                </h6>
                                            </td>
                                            <td style="border-right:0">
                                                <h6 class="mb-0">
                                                    <?php echo !empty($contract["maturity_date"]) ? Model::dateTimeFromUTC('Y-m-d',$contract['maturity_date'],$bank_demographic_data['timezone']) : ''; ?>
                                                </h6>
                                            </td>
                                        </tr>
                                <?php
