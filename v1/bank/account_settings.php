...
if ( AuthModel::isLoggedIn() ) {
    ...
    Core::activityLog("Bank Account Settings");
?>
...
<!--                                            <input type="hidden" name="_token" value="--><?php //echo $token; ?><!--"/>-->
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-8">
                                                    <label style="font-weight:bold"><label style="font-weight:bold"><div id="parent"> Upload Image:
...
<!--                                            <input type="hidden" name="_token" value="--><?php //echo $token; ?><!--"/>-->
                                            <a href="logic?update_password=1&&_token=<?php echo $token; ?>" class="btn btn-primary mmy_btn myinput update_password" style="margin-bottom: 5px">
                                                Reset Password
                                            </a>
<!--                                        </form>-->
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-8">
                                                    <!-- <div class="col-lg-12"> -->
                                                        ...
                                                        <input type="text" disabled name="institution" class="form-control myinput" placeholder="Institution" value="<?php echo Core::render($user_data['name']); ?>" required />
                                                    <!-- </div> -->
                                                </div>
											...
											<div class="col-lg-8">
                                                <div style="display: inline-block;width: 90%">
                                                    <label style="font-weight:bold">Short Term Credit Rating</label>
                                                        ...
                                                        <select class="form-control" name="short" required>
                                                            <option value="">--Select--</option>
                                                            <?php
                                                            ...
                                                            ?>
                                                                    <option <?php echo strtolower($item['description']) == strtolower(@$ratings['credit_rating']) ? 'selected' : '';?> value="<?php echo $item['id'];?>"><?php echo $item['description'] == "Any/Not Rated" ? "Not Rated" : $item['description'];?></option>
                                                            <?php
                                                                    }
                                                                }
                                                            ?>
                                        ...
                                        <div class="form-group row">
											<div class="col-lg-8">
                                                <!-- <div class="col-lg-12"> -->
                                                    ...
                                                    <select class="form-control" name="long" required>
                                                        <option value="">--Select--</option>
                                                        <?php
